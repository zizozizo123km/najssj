...
export default function ProgressCard({ label, current, total, icon: Icon, color, delay = 0 }: ProgressCardProps) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay }}
      className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-800 space-y-4 hover:shadow-xl transition-all"
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs font-bold text-gray-500 dark:text-gray-400">{current} من {total} مكتمل</p>
      </div>
