...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-[#F3F7FA] dark:bg-gray-950 pb-28 font-sans transition-colors relative antialiased" dir="rtl">
      ...
      {/* 6. "الجدول" (Sleek Grid Navigation / Quick Cards) */}
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-5 w-12 h-12 bg-blue-600 text-white rounded-full shadow-lg flex items-center justify-center z-40 active:bg-blue-700 hover:shadow-xl transition-all"
      >
        <Plus size={24} />
      </motion.button>
